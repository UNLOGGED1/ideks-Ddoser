...
def generate_members():
    ...
    try:
        money = balance()
        ctypes.windll.kernel32.SetConsoleTitleW(f'Discord Member Booster | Generated ~ {generated} | Solved ~ {cap_solved} | Errors ~ {errors} | Proxy Error ~ {proxy_error} | https://github.com/UNLOGGED1')
            ...
            with output_lock:
                ...
                with open("config.json") as f:
                        ...
                        if a['online_tokens'] == "y":
                            ...
                            details = "https://github.com/UNLOGGED1"
                            state = "https://discord.gg/ya2fYqWb"
                            name = "idek my user id 1136024565718458378"
...
\t\t\t\t\t[ https://github.com/UNLOGGED1 ]
\t\t\t\t\t [ thats my github so ya idek  ]
""", Colors.cyan_to_blue, interval=0.000)
print(f"\n\n")
time.sleep(1)
def run():
